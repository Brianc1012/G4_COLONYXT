...
class PreviewThemeAPI extends Endpoint implements CollectionEndpoint
{
     ...
     *                 property="data",
     *                 type="object",
     *                 @OA\Property(property="--oxd-primary-one-color", type="string", example="#0b6449"),
     *                 @OA\Property(property="--oxd-primary-font-color", type="string", example="#FFFFFF"),
     *                 @OA\Property(property="--oxd-secondary-four-color", type="string", example="#123524"),
     *                 @OA\Property(property="--oxd-secondary-font-color", type="string", example="#FFFFFF"),
     *                 @OA\Property(property="--oxd-primary-gradient-start-color", type="string", example="#16404D"),
     *                 @OA\Property(property="--oxd-primary-gradient-end-color", type="string", example="#3D8D7A"),
     *                 @OA\Property(property="--oxd-secondary-gradient-start-color", type="string", example="#16404D"),
     *                 @OA\Property(property="--oxd-secondary-gradient-end-color", type="string", example="#3D8D7A"),
